...
public class PredstavitelDialog extends AbstractDialog {
    ...
    class NaturalPersonForm extends SidePanel {
        public NaturalPersonForm(ComponentMap componentMap) {
            ...
            createRow("Тип документа удостоверяющий личность", genListField(new ListDialog(Resource.getInstance().passportType, null, "Тип документа удостоверяющий личность", new Dimension(400, 600)))).setBg(specialColor);
