...
public class VladelecDialog extends AbstractDialog {
    ...
    class AddressForm extends SidePanel{
        public AddressForm(ComponentMap componentMap) {
            ...
            createRow(StrConst.vladelec.adresReg.strana, genSpecialField(new ListDialog(Resource.getInstance().nationality, null, StrConst.vladelec.adresReg.strana, new Dimension(400, 600))));
            createRow(StrConst.vladelec.adresReg.subectRf, genSpecialField(new ListDialog(Resource.getInstance().russianRegion, null, StrConst.vladelec.adresReg.subectRf, new Dimension(400, 600))));
